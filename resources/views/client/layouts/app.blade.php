			...
			<div class="row">
				...
				<div id="content" class="col-xs-12">
					...
					<div id="carousel" class="owl-carousel nxt">
						...
						<div class="item text-center"> <a href="#"><img src="/client//product/canon_logo-100x100.jpg" alt="brand1" class="img-responsive" /></a> </div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="contact col-lg-4 col-md-4 col-sm-12 col-xs-12">
						...
						<img alt="" src="/client/logo-small.png">
					</div>
